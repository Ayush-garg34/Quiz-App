...
public class Main5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button next = findViewById(R.id.Q5Next);
        option1 = findViewById(R.id.Q5C1);
        option2 = findViewById(R.id.Q5C2);
        option3 = findViewById(R.id.Q5C3);
        option4 = findViewById(R.id.Q5C4);

        next.setVisibility(View.GONE);
        Submit = findViewById(R.id.Q5Submit);
