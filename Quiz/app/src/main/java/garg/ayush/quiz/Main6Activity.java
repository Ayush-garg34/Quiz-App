...
public class Main6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button next = findViewById(R.id.Q6Next);
        option1 = findViewById(R.id.Q6C1);
        option2 = findViewById(R.id.Q6C2);
        option3 = findViewById(R.id.Q6C3);
        option4 = findViewById(R.id.Q6C4);

        Submit = findViewById(R.id.Q6Submit);
