...
public class Main7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button next = findViewById(R.id.Q7Next);
        final CheckBox option1, option2, option3, option4;
        Button Submit;

        option1 = findViewById(R.id.Q7C1);
        option2 = findViewById(R.id.Q7C2);
        option3 = findViewById(R.id.Q7C3);
        option4 = findViewById(R.id.Q7C4);

        Submit = findViewById(R.id.Q7Submit);
