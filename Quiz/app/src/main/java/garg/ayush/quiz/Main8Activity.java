...
public class Main8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button next = findViewById(R.id.Q8Next);

        option1 = findViewById(R.id.Q8C1);
        option2 = findViewById(R.id.Q8C2);
        option3 = findViewById(R.id.Q8C3);
        option4 = findViewById(R.id.Q8C4);

        Submit = findViewById(R.id.Q8Submit);
