...
public class Main10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
            ...
            final Button next = findViewById(R.id.Q10Next);


            option1 = findViewById(R.id.Q10C1);
            option2 = findViewById(R.id.Q10C2);
            option3 = findViewById(R.id.Q10C3);
            option4 = findViewById(R.id.Q10C4);

            Submit = findViewById(R.id.Q10Submit);
