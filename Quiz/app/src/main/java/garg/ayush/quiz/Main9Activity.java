...
public class Main9Activity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main9);
            ...
            final Button next = findViewById(R.id.Q9Next);

            option1 = findViewById(R.id.Q9C1);
            option2 = findViewById(R.id.Q9C2);
            option3 = findViewById(R.id.Q9C3);
            option4 = findViewById(R.id.Q9C4);

            Submit = findViewById(R.id.Q9Submit);
