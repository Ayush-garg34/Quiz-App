...
public class Main15Activity extends AppCompatActivity implements FirebaseAuth.AuthStateListener {
    ...
    public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
        if (firebaseAuth.getCurrentUser() == null) {
            ...
            option1 = findViewById(R.id.Q15C1);
            option2 = findViewById(R.id.Q15C2);
            option3 = findViewById(R.id.Q15C3);
            option4 = findViewById(R.id.Q15C4);

            Submit = findViewById(R.id.Q15Submit);
