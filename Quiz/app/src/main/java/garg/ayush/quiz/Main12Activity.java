...
public class Main12Activity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main12);
            ...
            final Button next = findViewById(R.id.Q12Next);



            option1 = findViewById(R.id.Q12C1);
            option2 = findViewById(R.id.Q12C2);
            option3 = findViewById(R.id.Q12C3);
            option4 = findViewById(R.id.Q12C4);

            Submit = findViewById(R.id.Q12Submit);
            ...
            Submit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    option4.setTextColor(Color.rgb(51,255,51));
