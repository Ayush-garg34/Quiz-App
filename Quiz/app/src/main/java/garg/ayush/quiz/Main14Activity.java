...
public class Main14Activity extends AppCompatActivity implements FirebaseAuth.AuthStateListener {
    ...
    public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
        if (firebaseAuth.getCurrentUser() == null) {
            ...
            option1 = findViewById(R.id.Q14C1);
            option2 = findViewById(R.id.Q14C2);
            option3 = findViewById(R.id.Q14C3);
            option4 = findViewById(R.id.Q14C4);

            Submit = findViewById(R.id.Q14Submit);
