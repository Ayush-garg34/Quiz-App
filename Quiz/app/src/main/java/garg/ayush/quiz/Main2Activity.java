...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CheckBox option2_1, option2, option3, option4;
        Button Submit;

        final Button next = findViewById(R.id.Q2Next);

        next.setVisibility(View.GONE);
        option2_1 = findViewById(R.id.Q2C1);
        option2 = findViewById(R.id.Q2C2);
        option3 = findViewById(R.id.Q2C3);
        option4 = findViewById(R.id.Q2C4);

        Submit = findViewById(R.id.Q2Submit);

        option2_1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                option2_1.setTextColor(Color.rgb(255, 51, 51));
            }
        });
